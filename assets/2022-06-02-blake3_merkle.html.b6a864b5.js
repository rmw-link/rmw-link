import{_ as t,r as o,o as p,c,a,b as e,F as l,d as n,e as u}from"./app.32c338c0.js";const r={},k=a("h1",{id:"arvore-merkle-baseada-em-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#arvore-merkle-baseada-em-blake3","aria-hidden":"true"},"#"),n(" \xC1rvore Merkle baseada em blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" tem um merkle tree subjacente, mas a interface exposta n\xE3o pode exportar o merkle tree."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" implementa a valida\xE7\xE3o do fluxo blake3, mas n\xE3o pode redimensionar os "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("peda\xE7os"),x=n(" subjacentes "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},q=n('(suporta "grupos de peda\xE7os" maiores para reduzir o espa\xE7o a\xE9reo'),w=n(" )."),v=a("p",null,"Isto significa que a bao consome 6% de espa\xE7o de armazenamento extra para registar a \xE1rvore merkle, o que \xE9 uma sobrecarga significativa para um \xEDndice de conte\xFAdo distribu\xEDdo.",-1),H=n("Assim, implementei "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("o blake3_merkle"),z=n(" para exportar 32 bytes de hash por 1MB de conte\xFAdo, com uma sobrecarga de armazenamento adicional de 0.3\u2031."),F=u(`<p><code>./examples/main.rs</code> Como se segue :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function D(L,M){const s=o("ExternalLinkIcon");return p(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),f,a("a",_,[g,e(s)]),x,a("a",y,[q,e(s)]),w]),v,a("p",null,[H,a("a",B,[E,e(s)]),z]),F],64)}var V=t(r,[["render",D],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
