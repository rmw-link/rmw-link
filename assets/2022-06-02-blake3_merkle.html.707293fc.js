import{_ as t,r as o,o as p,c,a,b as e,F as l,d as n,e as u}from"./app.525299a3.js";const r={},k=a("h1",{id:"merkleboom-gebaseerd-op-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#merkleboom-gebaseerd-op-blake3","aria-hidden":"true"},"#"),n(" Merkleboom gebaseerd op blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" is gebaseerd op een merkle tree implementatie, maar de blootgelegde interface exporteert geen merkle trees."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),_=n(" implementeert streaming blake3 validatie, maar "),f={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("ondersteunt"),v=n(" niet het wijzigen van de grootte van de onderliggende "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('chunks (ondersteuning van grotere "chunk groups" voor minder ruimte-overhead'),w=n(" )."),q=a("p",null,"De huidige implementatie van bao verbruikt 6% extra opslagruimte om validatie-hashes op te slaan, wat een aanzienlijke overhead is voor een inhoudsindexeringsserver.",-1),H=n("Mijn implementatie van "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},z=n("blake3_merkle"),E=n(", wanneer "),D=a("code",null,"BLOCK_CHUNK",-1),F=n(" is ingesteld op 10, voert een 32-byte hash uit voor elke (1 << 10)*1024 = 1MB, wat slechts 0.3\u2031 extra overhead toevoegt."),L=u(`<p><code>./examples/main.rs</code> Als volgt :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function M(N,j){const s=o("ExternalLinkIcon");return p(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),_,a("a",f,[g,e(s)]),v,a("a",x,[y,e(s)]),w]),q,a("p",null,[H,a("a",B,[z,e(s)]),E,D,F]),L],64)}var V=t(r,[["render",M],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
