import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{e as n}from"./app.87d927ab.js";const t={},r=n(`<h1 id="electron-perfect-drag-and-drop-een-elegantere-implementatie-dan-electron-drag" tabindex="-1"><a class="header-anchor" href="#electron-perfect-drag-and-drop-een-elegantere-implementatie-dan-electron-drag" aria-hidden="true">#</a> electron perfect drag and drop : een elegantere implementatie dan electron-drag</h1><p>De productmanager heeft gevraagd of de werkbalk onder het elektronenvenster de rechtermuisknop kan blokkeren.</p><p>De native drag and drop in electron onder window ( <code>app-region:drag</code>) vreet de click event en er is geen manier om rechtsklik te blokkeren. Je moet het slepen en neerzetten handmatig uitvoeren.</p><p>Als je het mousemove event gebruikt om de eis te implementeren, gaat de muis, wanneer hij snel beweegt, buiten het bereik van het venster en volgt het venster de muis niet langer.</p><p>Ik heb deze eis ge\xEFmplementeerd op basis van de pointer event, met <a href="https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture" target="_blank" rel="noopener noreferrer">setPointerCapture</a> om de muispositie buiten het BrowserWindow vast te leggen, en het werkt perfect.</p><p>Deze oplossing is beter dan de electron-drag oplossing: het heeft platform-afhankelijke binaire afhankelijkheden en kan een pijn zijn om te upgraden en te packagen.</p><p>Ik ontdekte dat nog niemand deze oplossing op het web heeft genoemd, dus ik blog erover en deel het.</p><p>De codeverschillen tussen de implementaties worden hieronder alleen ter referentie opgesomd. De kerncode is <code>web/src/lib/drag.coffee</code> en <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $on from &#39;~/lib/on.coffee&#39;
