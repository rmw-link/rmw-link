import{_ as e,r as t,o as p,c as o,a as n,b as c,F as l,d as a,e as r}from"./app.dd3830d7.js";const i={},u=n("h1",{id:"electron-perfect-drag-and-drop-elegantnejsia-implementacia-ako-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-elegantnejsia-implementacia-ako-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : elegantnej\u0161ia implement\xE1cia ako electron-drag")],-1),k=n("p",null,"Mana\u017E\xE9r produktu po\u017Eiadal, aby panel n\xE1strojov pod oknom elektr\xF3nu blokoval prav\xE9 tla\u010Didlo my\u0161i.",-1),d=n("p",null,[a("Pri nat\xEDvnom \u0165ahan\xED a p\xFA\u0161\u0165an\xED v elektr\xF3ne pod oknom ( "),n("code",null,"app-region:drag"),a(") sa udalos\u0165 kliknutia spotrebuje a neexistuje sp\xF4sob, ako blokova\u0165 kliknutie prav\xFDm tla\u010Didlom my\u0161i. Presunutie mus\xEDte vykona\u0165 ru\u010Dne.")],-1),f=n("p",null,"Ak na implement\xE1ciu tejto po\u017Eiadavky pou\u017Eijete udalos\u0165 mousemove, pri r\xFDchlom pohybe my\u0161i sa t\xE1to dostane mimo dosahu okna a okno u\u017E nebude sledova\u0165 my\u0161.",-1),m=a("T\xFAto po\u017Eiadavku som implementoval na z\xE1klade udalosti ukazovate\u013Ea pomocou funkcie "),g={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),v=a(" na zachytenie polohy my\u0161i mimo okna BrowserWindow a funguje to dokonale."),w=r(`<p>Toto rie\u0161enie je lep\u0161ie ako rie\u0161enie electron-drag: m\xE1 bin\xE1rne z\xE1vislosti z\xE1visl\xE9 od platformy a jeho aktualiz\xE1cia a balenie m\xF4\u017Ee by\u0165 nepr\xEDjemn\xE9.</p><p>Zistil som, \u017Ee toto rie\u0161enie na webe e\u0161te nikto nespom\xEDnal, preto o \u0148om p\xED\u0161em na blogu a zdie\u013Eam ho.</p><p>Rozdiely v k\xF3de medzi jednotliv\xFDmi implement\xE1ciami s\xFA uveden\xE9 ni\u017E\u0161ie len na porovnanie. Z\xE1kladn\xFD k\xF3d je <code>web/src/lib/drag.coffee</code> a <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function y(b,_){const s=t("ExternalLinkIcon");return p(),o(l,null,[u,k,d,f,n("p",null,[m,n("a",g,[h,c(s)]),v]),w],64)}var j=e(i,[["render",y],["__file","2022-03-14.electron-drag.html.vue"]]);export{j as default};
