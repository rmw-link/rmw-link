import{_ as t,r as o,o as p,c,a,b as e,F as l,d as n,e as u}from"./app.525299a3.js";const r={},k=a("h1",{id:"arvore-merkle-baseada-em-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#arvore-merkle-baseada-em-blake3","aria-hidden":"true"},"#"),n(" \xC1rvore Merkle baseada em blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" baseia-se numa implementa\xE7\xE3o de merkle tree, mas a interface exposta n\xE3o exporta merkle trees."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),_=n(" implementa a valida\xE7\xE3o blake3 streaming, mas n\xE3o suporta o redimensionamento dos "),f={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("peda\xE7os"),x=n(" subjacentes "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},q=n('(suporta "grupos de peda\xE7os" maiores para reduzir o espa\xE7o a\xE9reo'),v=n(" )."),w=a("p",null,"A implementa\xE7\xE3o actual da bao consome 6% de espa\xE7o de armazenamento extra para registar hashes de valida\xE7\xE3o, o que \xE9 uma sobrecarga significativa para um servidor de indexa\xE7\xE3o de conte\xFAdos.",-1),H=n("A minha implementa\xE7\xE3o de "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle"),z=n(", quando "),C=a("code",null,"BLOCK_CHUNK",-1),F=n(" est\xE1 definida para 10, produz um hash de 32 bytes para cada (1 <<10)*1024 = 1MB, adicionando apenas 0.3\u2031 de despesas gerais adicionais."),L=u(`<p><code>./examples/main.rs</code> Como se segue :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>Corre <code>./example.main.sh</code>e o resultado ser\xE1 parecido com o seguinte</p><div class="language-text ext-text"><pre class="language-text"><code>[examples/main.rs:14] &amp;merkle.li = [
    HashDepth {
        hash: Hash(
...
</code></pre></div>`,4);function N(A,D){const s=o("ExternalLinkIcon");return p(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),_,a("a",f,[g,e(s)]),x,a("a",y,[q,e(s)]),v]),w,a("p",null,[H,a("a",B,[E,e(s)]),z,C,F]),L],64)}var M=t(r,[["render",N],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{M as default};
