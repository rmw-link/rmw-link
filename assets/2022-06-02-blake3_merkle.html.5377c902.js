import{_ as t,r as p,o,c,a,b as e,F as l,d as n,e as k}from"./app.cc5206ad.js";const u={},r=a("h1",{id:"drevo-merkle-ki-temelji-na-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#drevo-merkle-ki-temelji-na-blake3","aria-hidden":"true"},"#"),n(" Drevo Merkle, ki temelji na blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("Blake3"),m=n(" temelji na drevesu merkle, vendar izpostavljeni vmesnik ne izva\u017Ea drevesa merkle."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" izvaja preverjanje preto\u010Dnosti blake3, vendar ne more spreminjati velikosti osnovnih "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},v=n("kosov"),g=n(" (glejte "),j={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('podporo ve\u010Djim "skupinam kosov" za zmanj\u0161anje prostorske obremenitve'),x=n(" )."),z=a("p",null,"To pomeni, da bao porabi 6 % dodatnega prostora za shranjevanje za zapisovanje drevesa merklov, kar je za porazdeljeni indeks vsebine precej\u0161en re\u017Eijski stro\u0161ek.",-1),w=n("Zato sem implementiral "),q={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},H=n("blake3_merkle"),B=n(" za izvoz 32 bajtov hasha na 1 MB vsebine, pri \u010Demer je dodatna re\u017Eija shranjevanja 0,3\u2031."),E=k(`<p><code>./examples/main.rs</code> Na naslednji na\u010Din :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function D(F,N){const s=p("ExternalLinkIcon");return o(),c(l,null,[r,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),f,a("a",_,[v,e(s)]),g,a("a",j,[y,e(s)]),x]),z,a("p",null,[w,a("a",q,[H,e(s)]),B]),E],64)}var M=t(u,[["render",D],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{M as default};
