import{_ as t,r as o,o as p,c,a,b as e,F as l,d as n,e as u}from"./app.a65c7036.js";const r={},k=a("h1",{id:"merkleboom-gebaseerd-op-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#merkleboom-gebaseerd-op-blake3","aria-hidden":"true"},"#"),n(" Merkleboom gebaseerd op blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" wordt ondersteund door een merkle tree, maar de blootgelegde interface exporteert de merkle tree niet."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" implementeert blake3 streaming validatie, maar kan de grootte van de onderliggende "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunks"),v=n(" niet wijzigen (zie "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('ondersteuning van grotere "chunk groups" voor minder ruimte-overhead'),w=n(" )."),q=a("p",null,"Dit betekent dat bao 6% extra opslagruimte nodig heeft om de merkle tree op te slaan, wat een aanzienlijke overhead is voor een gedistribueerde inhoudsindex.",-1),H=n("Dus heb ik "),z={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},B=n("blake3_merkle"),D=n(" ge\xEFmplementeerd om 32 bytes hash te exporteren per 1MB inhoud, met een extra opslagoverhead van 0.3\u2031."),E=u(`<p>De merkle boom kan hashes genereren die consistent zijn met blake3.</p><p>Wanneer de inhoud kleiner is dan of gelijk aan 1MB, heeft de merkle tree slechts \xE9\xE9n knoop en de hash van deze knoop is gelijk aan de hash van blake3.</p><p><code>./examples/main.rs</code> Als volgt :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>Start <code>./example.main.sh</code>en de uitvoer zal er als volgt uitzien</p><div class="language-text ext-text"><pre class="language-text"><code>[examples/main.rs:14] &amp;merkle.li = [
    HashDepth {
        hash: Hash(
...
</code></pre></div>`,6);function j(F,M){const s=o("ExternalLinkIcon");return p(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),f,a("a",_,[g,e(s)]),v,a("a",x,[y,e(s)]),w]),q,a("p",null,[H,a("a",z,[B,e(s)]),D]),E],64)}var N=t(r,[["render",j],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{N as default};
