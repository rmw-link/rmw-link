import{_ as t,r as p,o,c,a,b as e,F as l,d as n,e as k}from"./app.a65c7036.js";const u={},r=a("h1",{id:"drevo-merkle-ki-temelji-na-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#drevo-merkle-ki-temelji-na-blake3","aria-hidden":"true"},"#"),n(" Drevo Merkle, ki temelji na blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("Blake3"),m=n(" temelji na drevesu merkle, vendar izpostavljeni vmesnik ne izva\u017Ea drevesa merkle."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" izvaja preverjanje preto\u010Dnosti blake3, vendar ne more spreminjati velikosti osnovnih "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},v=n("kosov"),j=n(" (glejte "),g={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('podporo ve\u010Djim "skupinam kosov" za zmanj\u0161anje prostorske obremenitve'),z=n(" )."),x=a("p",null,"To pomeni, da bao za zapis drevesa merklov porabi dodatnih 6 % prostora za shranjevanje, kar je za porazdeljeni indeks vsebine precej\u0161en re\u017Eijski stro\u0161ek.",-1),w=n("Zato sem implementiral "),q={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},H=n("blake3_merkle"),B=n(" za izvoz 32 bajtov hasha na 1 MB vsebine, pri \u010Demer je dodatna re\u017Eija shranjevanja 0,3\u2031."),E=k(`<p>Merklovo drevo lahko ustvari hashe, ki so skladni z blake3.</p><p>\u010Ce je vsebina manj\u0161a ali enaka 1 MB, ima drevo merklov samo eno vozli\u0161\u010De in hash tega vozli\u0161\u010Da je enak hashu blake3.</p><p><code>./examples/main.rs</code> Na naslednji na\u010Din :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>Za\u017Eenite <code>./example.main.sh</code>in rezultat bo videti takole</p><div class="language-text ext-text"><pre class="language-text"><code>[examples/main.rs:14] &amp;merkle.li = [
    HashDepth {
        hash: Hash(
...
</code></pre></div>`,6);function M(D,F){const s=p("ExternalLinkIcon");return o(),c(l,null,[r,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),f,a("a",_,[v,e(s)]),j,a("a",g,[y,e(s)]),z]),x,a("p",null,[w,a("a",q,[H,e(s)]),B]),E],64)}var L=t(u,[["render",M],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{L as default};
