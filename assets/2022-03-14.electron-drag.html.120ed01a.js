import{_ as e,r as t,o as p,c as o,a as n,b as c,F as r,d as a,e as l}from"./app.525299a3.js";const i={},u=n("h1",{id:"drag-and-drop-perfeito-de-electroes-uma-implementacao-mais-elegante-do-que-o-arrastamento-de-electroes",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#drag-and-drop-perfeito-de-electroes-uma-implementacao-mais-elegante-do-que-o-arrastamento-de-electroes","aria-hidden":"true"},"#"),a(" drag and drop perfeito de electr\xF5es : uma implementa\xE7\xE3o mais elegante do que o arrastamento de electr\xF5es")],-1),k=n("p",null,"O gestor do produto solicitou que a barra de ferramentas sob a janela de electr\xF5es bloqueasse o bot\xE3o direito do rato.",-1),d=n("p",null,[a("O arrastar e largar do electr\xE3o nativo sob janela ( "),n("code",null,"app-region:drag"),a(") come o evento do clique e n\xE3o h\xE1 maneira de fazer o bloqueio do clique direito. \xC9 necess\xE1rio implementar o arrastar e largar manualmente.")],-1),f=n("p",null,"Se utilizar o evento mousemove para implementar o requisito, quando o rato se move rapidamente, ele sai do alcance da janela e a janela j\xE1 n\xE3o segue o rato.",-1),m=a("Implementei este requisito com base no evento ponteiro, utilizando "),g={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),w=a(" para capturar a posi\xE7\xE3o do rato fora da janela do BrowserWindow, e funciona perfeitamente."),b=l(`<p>Esta solu\xE7\xE3o \xE9 melhor do que a solu\xE7\xE3o de arrastamento de electr\xF5es: tem depend\xEAncias bin\xE1rias dependentes da plataforma e pode ser um inc\xF3modo para actualizar e embalar.</p><p>Descobri que ainda ningu\xE9m mencionou esta solu\xE7\xE3o na web, por isso estou a fazer um blogue sobre ela e a partilh\xE1-la.</p><p>As diferen\xE7as de c\xF3digo entre as implementa\xE7\xF5es s\xE3o listadas abaixo apenas para refer\xEAncia. O c\xF3digo central \xE9 <code>web/src/lib/drag.coffee</code> e <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function v(y,_){const s=t("ExternalLinkIcon");return p(),o(r,null,[u,k,d,f,n("p",null,[m,n("a",g,[h,c(s)]),w]),b],64)}var q=e(i,[["render",v],["__file","2022-03-14.electron-drag.html.vue"]]);export{q as default};
