import{_ as e,r as p,o,c,a as s,b as t,F as l,d as n,e as u}from"./app.cc5206ad.js";const r={},k=s("h1",{id:"merkle-tree-based-on-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-tree-based-on-blake3","aria-hidden":"true"},"#"),n(" merkle tree based on blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),h=n(" is based on merkle tree, but the exposed interface cannot export merkle tree."),m={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},f=n("bao"),b=n(" implements blake3 streaming verification, but cannot resize the underlying "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunks"),x=n(" (see "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},w=n('support larger "chunk groups" for reduced space overhead'),q=n(" )."),v=s("p",null,"This means that bao consumes 6% extra storage space to record the merkle tree, which is a significant overhead for a distributed content index.",-1),H=n("So, I implemented "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle"),F=n(" to export 32 bytes of hash per 1MB of content with an additional storage overhead of only 0.3\u2031."),z=u(`<p><code>./examples/main.rs</code> As follows :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function D(L,N){const a=p("ExternalLinkIcon");return o(),c(l,null,[k,s("p",null,[s("a",i,[d,t(a)]),h]),s("p",null,[s("a",m,[f,t(a)]),b,s("a",_,[g,t(a)]),x,s("a",y,[w,t(a)]),q]),v,s("p",null,[H,s("a",B,[E,t(a)]),F]),z],64)}var A=e(r,[["render",D],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{A as default};
