import{_ as t,r as p,o,c,a as n,b as e,F as l,d as a,e as k}from"./app.32c338c0.js";const u={},r=n("h1",{id:"drevo-merkle-ki-temelji-na-blake3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#drevo-merkle-ki-temelji-na-blake3","aria-hidden":"true"},"#"),a(" Drevo Merkle, ki temelji na blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=a("blake3"),m=a(" ima osnovno drevo merkle, vendar izpostavljeni vmesnik ne more izvoziti drevesa merkle."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=a("bao"),f=a(" izvaja preverjanje preto\u010Dnosti blake3, vendar ne more spreminjati velikosti osnovnih "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},v=a('kosov (podpira ve\u010Dje "skupine kosov" za zmanj\u0161anje re\u017Eijskega prostora'),g=a(" )."),j=n("p",null,"To pomeni, da bao porabi 6 % dodatnega prostora za shranjevanje za zapisovanje drevesa merklov, kar je za porazdeljeni indeks vsebine precej\u0161en re\u017Eijski stro\u0161ek.",-1),y=a("Zato sem implementiral "),x={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},z=a("blake3_merkle"),w=a(" za izvoz 32 bajtov hasha na 1 MB vsebine, pri \u010Demer je dodatna re\u017Eija shranjevanja 0,3\u2031."),q=k(`<p><code>./examples/main.rs</code> Na naslednji na\u010Din :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function H(B,E){const s=p("ExternalLinkIcon");return o(),c(l,null,[r,n("p",null,[n("a",i,[d,e(s)]),m]),n("p",null,[n("a",h,[b,e(s)]),f,n("a",_,[v,e(s)]),g]),j,n("p",null,[y,n("a",x,[z,e(s)]),w]),q],64)}var F=t(u,[["render",H],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{F as default};
