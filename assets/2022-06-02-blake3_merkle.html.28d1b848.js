import{_ as t,r as p,o,c,a as s,b as e,F as l,d as n,e as r}from"./app.525299a3.js";const u={},k=s("h1",{id:"merkle-tr\xE6-baseret-pa-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-tr\xE6-baseret-pa-blake3","aria-hidden":"true"},"#"),n(" Merkle-tr\xE6 baseret p\xE5 blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" er baseret p\xE5 en implementering af merkle-tr\xE6er, men den eksponerede gr\xE6nseflade eksporterer ikke merkle-tr\xE6er."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},f=n("bao"),b=n(" implementerer streaming blake3-validering, men "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("underst\xF8tter"),y=n(" ikke \xE6ndring af st\xF8rrelsen af de underliggende "),v={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},x=n('chunks (underst\xF8tter st\xF8rre "chunk-grupper" for at reducere pladsoverhead'),w=n(" )."),q=s("p",null,"Den nuv\xE6rende implementering af bao bruger 6 % ekstra lagerplads til at registrere valideringshashes, hvilket er et betydeligt overhead for en indholdsindekseringsserver.",-1),H=n("Min implementering af "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle"),D=n(", n\xE5r "),F=s("code",null,"BLOCK_CHUNK",-1),K=n(" er sat til 10, udsender en 32-byte hash for hver (1 << 10)*1024 = 1 MB, hvilket kun tilf\xF8jer 0,3\u2031 ekstra overhead."),L=r(`<p><code>./examples/main.rs</code> Som f\xF8lger :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function M(N,V){const a=p("ExternalLinkIcon");return o(),c(l,null,[k,s("p",null,[s("a",i,[d,e(a)]),m]),s("p",null,[s("a",h,[f,e(a)]),b,s("a",_,[g,e(a)]),y,s("a",v,[x,e(a)]),w]),q,s("p",null,[H,s("a",B,[E,e(a)]),D,F,K]),L],64)}var C=t(u,[["render",M],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{C as default};
