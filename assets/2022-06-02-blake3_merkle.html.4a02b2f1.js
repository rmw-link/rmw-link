import{_ as t,r as p,o,c,a as s,b as e,F as l,d as n,e as u}from"./app.32c338c0.js";const r={},k=s("h1",{id:"arbre-de-merkle-base-sur-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#arbre-de-merkle-base-sur-blake3","aria-hidden":"true"},"#"),n(" Arbre de Merkle bas\xE9 sur blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" poss\xE8de un arbre de merkle sous-jacent, mais l'interface expos\xE9e ne peut pas exporter l'arbre de merkle."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" impl\xE9mente la validation de flux blake3, mais ne peut pas redimensionner les "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunks"),x=n(" sous-jacents ( "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},q=n(`supporte des "groupes de chunks" plus grands pour r\xE9duire l'encombrement`),w=n(" )."),v=s("p",null,"Cela signifie que bao consomme 6 % d'espace de stockage suppl\xE9mentaire pour enregistrer l'arbre de merkle, ce qui repr\xE9sente une surcharge importante pour un index de contenu distribu\xE9.",-1),H=n("J'ai donc impl\xE9ment\xE9 "),E={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},B=n("blake3_merkle"),F=n(" pour exporter 32 octets de hachage par 1 Mo de contenu, avec une surcharge de stockage suppl\xE9mentaire de 0,3\u2031."),z=u(`<p><code>./examples/main.rs</code> Comme suit :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function D(L,M){const a=p("ExternalLinkIcon");return o(),c(l,null,[k,s("p",null,[s("a",i,[d,e(a)]),m]),s("p",null,[s("a",h,[b,e(a)]),f,s("a",_,[g,e(a)]),x,s("a",y,[q,e(a)]),w]),v,s("p",null,[H,s("a",E,[B,e(a)]),F]),z],64)}var V=t(r,[["render",D],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
