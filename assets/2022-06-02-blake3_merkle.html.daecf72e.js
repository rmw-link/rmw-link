import{_ as e,r as p,o,c,a as n,b as t,F as l,d as a,e as r}from"./app.32c338c0.js";const u={},k=n("h1",{id:"merkle-trad-baserat-pa-blake3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#merkle-trad-baserat-pa-blake3","aria-hidden":"true"},"#"),a(" Merkle-tr\xE4d baserat p\xE5 blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=a("blake3"),m=a(" har ett underliggande merkle-tr\xE4d, men det exponerade gr\xE4nssnittet kan inte exportera merkle-tr\xE4det."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=a("bao"),f=a(" implementerar blake3-str\xF6mningsvalidering, men kan inte \xE4ndra storleken p\xE5 de underliggande "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=a('bitarna (st\xF6djer st\xF6rre "bitgrupper" f\xF6r att minska utrymmes\xF6verskottet'),x=a(" )."),y=n("p",null,"Detta inneb\xE4r att bao f\xF6rbrukar 6 % extra lagringsutrymme f\xF6r att registrera Merkle-tr\xE4det, vilket \xE4r en betydande \xF6verkostnad f\xF6r ett distribuerat inneh\xE5llsindex.",-1),w=a("S\xE5 jag implementerade "),q={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},v=a("blake3_merkle"),H=a(" f\xF6r att exportera 32 bytes hash per 1 MB inneh\xE5ll, med en extra lagrings\xF6verskottstid p\xE5 0,3\u2031."),B=r(`<p><code>./examples/main.rs</code> F\xF6ljande g\xE4ller:</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function E(F,D){const s=p("ExternalLinkIcon");return o(),c(l,null,[k,n("p",null,[n("a",i,[d,t(s)]),m]),n("p",null,[n("a",h,[b,t(s)]),f,n("a",_,[g,t(s)]),x]),y,n("p",null,[w,n("a",q,[v,t(s)]),H]),B],64)}var j=e(u,[["render",E],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{j as default};
