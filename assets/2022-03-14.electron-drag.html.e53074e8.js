import{_ as e,r as t,o as p,c as o,a as n,b as c,F as r,d as a,e as l}from"./app.525299a3.js";const i={},u=n("h1",{id:"electron-perfect-drag-and-drop-elegantnejsa-izvedba-kot-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-elegantnejsa-izvedba-kot-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : elegantnej\u0161a izvedba kot electron-drag")],-1),k=n("p",null,"Vodja izdelka je zahteval, da orodna vrstica pod oknom electron blokira desni mi\u0161kin gumb.",-1),d=n("p",null,[a("Naravni na\u010Din vle\u010Denja in spu\u0161\u010Danja v elektronu pod oknom ( "),n("code",null,"app-region:drag"),a(") poje dogodek klika in ni na\u010Dina za blokiranje desnega klika. Funkcijo povleci in spusti morate izvajati ro\u010Dno.")],-1),f=n("p",null,"\u010Ce za izvajanje zahteve uporabite dogodek mousemove, mi\u0161ka ob hitrem premiku zapusti obmo\u010Dje okna in okno ne sledi ve\u010D mi\u0161ki.",-1),g=a("To zahtevo sem izvedel na podlagi dogodka kazalca, pri \u010Demer sem za zajem polo\u017Eaja mi\u0161ke zunaj okna BrowserWindow uporabil "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},v=a("setPointerCapture"),h=a(", in deluje odli\u010Dno."),w=l(`<p>Ta re\u0161itev je bolj\u0161a od re\u0161itve electron-drag: ima binarne odvisnosti, ki so odvisne od platforme, nadgradnja in pakiranje pa sta lahko te\u017Eavna.</p><p>Ugotovil sem, da te re\u0161itve na spletu \u0161e nih\u010De ni omenil, zato o njej pi\u0161em na blogu in jo delim z drugimi.</p><p>Razlike v kodi med izvedbami so spodaj navedene samo za referenco. Osnovna koda je <code>web/src/lib/drag.coffee</code> in <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function b(y,_){const s=t("ExternalLinkIcon");return p(),o(r,null,[u,k,d,f,n("p",null,[g,n("a",m,[v,c(s)]),h]),w],64)}var j=e(i,[["render",b],["__file","2022-03-14.electron-drag.html.vue"]]);export{j as default};
