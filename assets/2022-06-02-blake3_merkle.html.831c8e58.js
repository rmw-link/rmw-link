import{_ as t,r as o,o as p,c,a,b as e,F as l,d as n,e as u}from"./app.8d0bec44.js";const k={},r=a("h1",{id:"merkleho-strom-zalozeny-na-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#merkleho-strom-zalozeny-na-blake3","aria-hidden":"true"},"#"),n(" Merkleho strom zalo\u017Een\xFD na blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" je zalo\u017Een\xFD na merkleovom strome, ale vystaven\xE9 rozhranie nedok\xE1\u017Ee exportova\u0165 merkleov strom."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" implementuje overovanie pr\xFAdenia blake3, ale nedok\xE1\u017Ee meni\u0165 ve\u013Ekos\u0165 z\xE1kladn\xFDch "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},v=n("chunkov"),g=n(" (pozri "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},x=n('podporu v\xE4\u010D\u0161\xEDch "chunk groups" pre zn\xED\u017Eenie priestorovej r\xE9\u017Eie'),z=n(" )."),w=a("p",null,"To znamen\xE1, \u017Ee bao spotrebuje 6 % \xFAlo\u017En\xE9ho priestoru navy\u0161e na zaznamenanie merkleovho stromu, \u010Do je pre distribuovan\xFD index obsahu v\xFDznamn\xE1 r\xE9\u017Eia.",-1),q=n("Preto som implementoval "),j={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},H=n("blake3_merkle"),B=n(" na z\xEDskanie 32 bajtov hash na 1 MB obsahu s dodato\u010Dnou r\xE9\u017Eiou ukladania 0,3\u2031."),E=u(`<p>Merkleho strom generuje hashe, ktor\xE9 s\xFA v s\xFAlade s blake3.</p><p>Ak je obsah men\u0161\xED alebo rovn\xFD 1 MB, merkleov strom m\xE1 len jeden uzol a hash tohto uzla sa rovn\xE1 hashu blake3.</p><p><code>./examples/main.rs</code> Takto :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,6);function M(F,D){const s=o("ExternalLinkIcon");return p(),c(l,null,[r,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),f,a("a",_,[v,e(s)]),g,a("a",y,[x,e(s)]),z]),w,a("p",null,[q,a("a",j,[H,e(s)]),B]),E],64)}var N=t(k,[["render",M],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{N as default};
