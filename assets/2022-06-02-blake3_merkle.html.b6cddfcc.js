import{_ as t,r as p,o,c,a as n,b as e,F as l,d as a,e as u}from"./app.32c338c0.js";const r={},k=n("h1",{id:"arbore-merkle-bazat-pe-blake3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#arbore-merkle-bazat-pe-blake3","aria-hidden":"true"},"#"),a(" Arbore Merkle bazat pe blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=a("blake3"),m=a(" are un arbore Merkle subiacent, dar interfa\u021Ba expus\u0103 nu poate exporta arborele Merkle."),b={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},h=a("bao"),f=a(" implementeaz\u0103 validarea de streaming blake3, dar nu poate redimensiona buc\u0103\u021Bile subiacente "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=a('(accept\u0103 "grupuri de buc\u0103\u021Bele" mai mari pentru reducerea spa\u021Biului'),x=a(" )."),y=n("p",null,"Acest lucru \xEEnseamn\u0103 c\u0103 bao consum\u0103 6% spa\u021Biu de stocare suplimentar pentru a \xEEnregistra arborele Merkle, ceea ce reprezint\u0103 un cost suplimentar semnificativ pentru un index de con\u021Binut distribuit.",-1),w=a("A\u0219adar, am implementat "),q={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},v=a("blake3_merkle"),H=a(" pentru a exporta 32 de octe\u021Bi de hash pentru fiecare 1 MB de con\u021Binut, cu o supratax\u0103 de stocare suplimentar\u0103 de 0,3\u2031."),z=u(`<p><code>./examples/main.rs</code> Dup\u0103 cum urmeaz\u0103 :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function B(E,M){const s=p("ExternalLinkIcon");return o(),c(l,null,[k,n("p",null,[n("a",i,[d,e(s)]),m]),n("p",null,[n("a",b,[h,e(s)]),f,n("a",_,[g,e(s)]),x]),y,n("p",null,[w,n("a",q,[v,e(s)]),H]),z],64)}var D=t(r,[["render",B],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{D as default};
