import{_ as e,r as p,o,c,a,b as t,F as l,d as n,e as u}from"./app.a65c7036.js";const k={},i=a("h1",{id:"blake3-een-perustuva-merkle-puu",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#blake3-een-perustuva-merkle-puu","aria-hidden":"true"},"#"),n(" Blake3:een perustuva Merkle-puu")],-1),r={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},m=n("blake3"),d=n(":n perustana on merkle-puu, mutta paljastettu k\xE4ytt\xF6liittym\xE4 ei vie merkle-puuta."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" toteuttaa blake3-suoratoistovarmennuksen, mutta ei pysty muuttamaan taustalla olevien "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n("lohkojen"),g=n(" kokoa (katso "),v={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},x=n('tuki suuremmille "lohkoryhmille", mik\xE4 v\xE4hent\xE4\xE4 tilankulutusta'),w=n(" )."),q=a("p",null,"T\xE4m\xE4 tarkoittaa, ett\xE4 bao kuluttaa 6 prosenttia ylim\xE4\xE4r\xE4ist\xE4 tallennustilaa merkle-puun tallentamiseen, mik\xE4 on merkitt\xE4v\xE4 yleiskustannus hajautetulle sis\xE4lt\xF6indeksille.",-1),H=n("Niinp\xE4 toteutin "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},j=n("blake3_merkle-toiminnon"),E=n(" viem\xE4\xE4n 32 tavua hashia 1 Mt:n sis\xE4lt\xF6\xE4 kohti, jolloin ylim\xE4\xE4r\xE4inen tallennuskustannus on 0,3\u2031."),M=u(`<p>Merkle-puu voi tuottaa blake3:n mukaisia hasheja.</p><p>Kun sis\xE4lt\xF6 on enint\xE4\xE4n 1MB, merkle-puussa on vain yksi solmu, ja t\xE4m\xE4n solmun hash on yht\xE4 suuri kuin blake3:n hash.</p><p><code>./examples/main.rs</code> seuraavasti :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,6);function F(N,D){const s=p("ExternalLinkIcon");return o(),c(l,null,[i,a("p",null,[a("a",r,[m,t(s)]),d]),a("p",null,[a("a",h,[b,t(s)]),f,a("a",_,[y,t(s)]),g,a("a",v,[x,t(s)]),w]),q,a("p",null,[H,a("a",B,[j,t(s)]),E]),M],64)}var V=e(k,[["render",F],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
