import{_ as e,r as p,o,c,a,b as t,F as l,d as n,e as u}from"./app.32c338c0.js";const i={},r=a("h1",{id:"albero-di-merkle-basato-su-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#albero-di-merkle-basato-su-blake3","aria-hidden":"true"},"#"),n(" Albero di Merkle basato su blake3")],-1),k={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" ha un albero di merkle sottostante, ma l'interfaccia esposta non pu\xF2 esportare l'albero di merkle."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" implementa la validazione dello streaming blake3, ma non pu\xF2 ridimensionare i "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunk"),y=n(" sottostanti "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},q=n(`(supporta "gruppi di chunk" pi\xF9 grandi per ridurre l'overhead di spazio`),v=n(" )."),w=a("p",null,"Ci\xF2 significa che bao consuma il 6% di spazio di archiviazione in pi\xF9 per registrare l'albero di merkle, che \xE8 un overhead significativo per un indice di contenuti distribuito.",-1),H=n("Ho quindi implementato "),z={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},B=n("blake3_merkle"),E=n(" per esportare 32 byte di hash per 1 MB di contenuto, con un overhead di memorizzazione aggiuntivo di 0,3\u2031."),F=u(`<p><code>./examples/main.rs</code> Come segue :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function D(L,M){const s=p("ExternalLinkIcon");return o(),c(l,null,[r,a("p",null,[a("a",k,[d,t(s)]),m]),a("p",null,[a("a",h,[b,t(s)]),f,a("a",_,[g,t(s)]),y,a("a",x,[q,t(s)]),v]),w,a("p",null,[H,a("a",z,[B,t(s)]),E]),F],64)}var V=e(i,[["render",D],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
