import{_ as t,r as p,o,c,a as s,b as e,F as l,d as n,e as r}from"./app.a65c7036.js";const k={},u=s("h1",{id:"merkle-tr\xE6-baseret-pa-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-tr\xE6-baseret-pa-blake3","aria-hidden":"true"},"#"),n(" Merkle-tr\xE6 baseret p\xE5 blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" underst\xF8ttes af et merkle-tr\xE6, men den eksponerede gr\xE6nseflade eksporterer ikke merkle-tr\xE6et."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" implementerer blake3 streaming-validering, men kan ikke \xE6ndre st\xF8rrelsen p\xE5 de underliggende "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunks"),y=n(" (se "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},v=n('underst\xF8ttelse af st\xF8rre "chunk-grupper" for at reducere pladsoverhead'),w=n(" )."),q=s("p",null,"Det betyder, at bao bruger yderligere 6 % af lagerpladsen til at registrere merkle-tr\xE6et, hvilket er et betydeligt overhead for et distribueret indholdsindeks.",-1),H=n("S\xE5 jeg implementerede "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle"),M=n(" til at eksportere 32 bytes hash pr. 1 MB indhold med et ekstra lageroverhead p\xE5 0,3\u2031."),D=r(`<p>Merkle-tr\xE6et kan generere hashes, der er i overensstemmelse med blake3.</p><p>N\xE5r indholdet er mindre end eller lig med 1 MB, har merkle-tr\xE6et kun \xE9n knude, og hash-koden for denne knude er lig med hash-koden for blake3.</p><p><code>./examples/main.rs</code> Som f\xF8lger :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>K\xF8r <code>./example.main.sh</code>, og resultatet vil se s\xE5ledes ud</p><div class="language-text ext-text"><pre class="language-text"><code>[examples/main.rs:14] &amp;merkle.li = [
    HashDepth {
        hash: Hash(
...
</code></pre></div>`,6);function F(N,L){const a=p("ExternalLinkIcon");return o(),c(l,null,[u,s("p",null,[s("a",i,[d,e(a)]),m]),s("p",null,[s("a",h,[b,e(a)]),f,s("a",_,[g,e(a)]),y,s("a",x,[v,e(a)]),w]),q,s("p",null,[H,s("a",B,[E,e(a)]),M]),D],64)}var z=t(k,[["render",F],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{z as default};
