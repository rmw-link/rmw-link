import{_ as t,r as p,o,c,a,b as e,F as l,d as n,e as u}from"./app.cc5206ad.js";const r={},k=a("h1",{id:"merkle-baum-auf-der-grundlage-von-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#merkle-baum-auf-der-grundlage-von-blake3","aria-hidden":"true"},"#"),n(" Merkle-Baum auf der Grundlage von Blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),h=n(" wird durch einen Merkle-Baum unterst\xFCtzt, aber die exponierte Schnittstelle exportiert den Merkle-Baum nicht."),m={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},f=n("bao"),b=n(" implementiert die Blake3-Streaming-Validierung, kann aber die Gr\xF6\xDFe der zugrundeliegenden "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("Chunks"),w=n(" nicht \xE4ndern (siehe "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('Unterst\xFCtzung gr\xF6\xDFerer "Chunk-Gruppen" zur Verringerung des Speicherplatz-Overheads'),v=n(" )."),B=a("p",null,"Dies bedeutet, dass bao 6 % zus\xE4tzlichen Speicherplatz f\xFCr die Aufzeichnung des Merkle-Baums verbraucht, was f\xFCr einen verteilten Inhaltsindex einen erheblichen Overhead darstellt.",-1),q=n("Daher habe ich "),z={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},H=n("blake3_merkle"),E=n(" so implementiert, dass 32 Byte Hash pro 1 MB Inhalt exportiert werden, was einen zus\xE4tzlichen Speicheraufwand von 0,3\u2031 bedeutet."),M=u(`<p><code>./examples/main.rs</code> Wie folgt:</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function S(D,F){const s=p("ExternalLinkIcon");return o(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),h]),a("p",null,[a("a",m,[f,e(s)]),b,a("a",_,[g,e(s)]),w,a("a",x,[y,e(s)]),v]),B,a("p",null,[q,a("a",z,[H,e(s)]),E]),M],64)}var A=t(r,[["render",S],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{A as default};
