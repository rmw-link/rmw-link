import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{e as n}from"./app.040d9bb0.js";const r={},t=n(`<h1 id="electron-perfect-drag-and-drop-eine-elegantere-implementierung-als-electron-drag" tabindex="-1"><a class="header-anchor" href="#electron-perfect-drag-and-drop-eine-elegantere-implementierung-als-electron-drag" aria-hidden="true">#</a> electron perfect drag and drop : eine elegantere Implementierung als electron-drag</h1><p>Der Produktmanager wollte, dass die Symbolleiste unter dem Elektronenfenster die rechte Maustaste blockiert.</p><p>Das native Drag &amp; Drop in Elektron unter Fenster ( <code>app-region:drag</code>) frisst das Klick-Ereignis und es gibt keine M\xF6glichkeit, einen Rechtsklick zu blockieren. Sie m\xFCssen das Ziehen und Ablegen manuell durchf\xFChren.</p><p>Wenn Sie das Mousemove-Ereignis verwenden, um die Anforderung umzusetzen, verl\xE4sst die Maus bei einer schnellen Bewegung den Bereich des Fensters und das Fenster folgt der Maus nicht mehr.</p><p>Ich habe diese Anforderung basierend auf dem Zeiger-Ereignis implementiert, mit <a href="https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture" target="_blank" rel="noopener noreferrer">setPointerCapture</a>, um die Mausposition au\xDFerhalb des BrowserWindow zu erfassen, und es funktioniert perfekt.</p><p>Diese L\xF6sung ist besser als die electron-drag-L\xF6sung: Sie hat plattformabh\xE4ngige Bin\xE4rabh\xE4ngigkeiten und kann m\xFChsam zu aktualisieren und zu paketieren sein.</p><p>Ich habe festgestellt, dass diese L\xF6sung noch von niemandem im Internet erw\xE4hnt wurde, also blogge ich dar\xFCber und teile sie.</p><p>Die Code-Unterschiede zwischen den Implementierungen sind nachstehend nur zu Referenzzwecken aufgef\xFChrt. Der Kerncode ist <code>web/src/lib/drag.coffee</code> und <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $on from &#39;~/lib/on.coffee&#39;
...
export default (elem, dict)=&gt;
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,23);function a(i,o){return t}var s=e(r,[["render",a],["__file","2022-03-14.electron-drag.html.vue"]]);export{s as default};
