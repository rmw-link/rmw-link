import{_ as t,r as p,o,c,a as n,b as e,F as l,d as a,e as r}from"./app.32c338c0.js";const u={},k=n("h1",{id:"merkle-tr\xE6-baseret-pa-blake3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#merkle-tr\xE6-baseret-pa-blake3","aria-hidden":"true"},"#"),a(" Merkle-tr\xE6 baseret p\xE5 blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=a("blake3"),m=a(" har et underliggende merkle-tr\xE6, men den udsatte gr\xE6nseflade kan ikke eksportere merkle-tr\xE6et."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=a("bao"),f=a(" implementerer blake3 streamingvalidering, men kan ikke \xE6ndre st\xF8rrelsen p\xE5 de underliggende "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=a('chunks (underst\xF8tter st\xF8rre "chunkgrupper" for at reducere pladsoverhead'),y=a(" )."),x=n("p",null,"Det betyder, at bao bruger 6 % ekstra lagerplads til at registrere merkle-tr\xE6et, hvilket er et betydeligt overhead for et distribueret indholdsindeks.",-1),w=a("S\xE5 jeg implementerede "),v={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},q=a("blake3_merkle"),H=a(" til at eksportere 32 bytes hash pr. 1 MB indhold med et ekstra lageroverhead p\xE5 0,3\u2031."),B=r(`<p><code>./examples/main.rs</code> Som f\xF8lger :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function E(D,F){const s=p("ExternalLinkIcon");return o(),c(l,null,[k,n("p",null,[n("a",i,[d,e(s)]),m]),n("p",null,[n("a",h,[b,e(s)]),f,n("a",_,[g,e(s)]),y]),x,n("p",null,[w,n("a",v,[q,e(s)]),H]),B],64)}var M=t(u,[["render",E],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{M as default};
