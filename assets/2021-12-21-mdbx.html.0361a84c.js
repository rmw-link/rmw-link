...
</code></pre></div><p>The output of</p><div class="language-text ext-text"><pre class="language-text"><code>(2, 4)
(1, 5)
(0, 0)
...
</code></pre></div><p>Start with <code>cargo add mdbx-speedy</code>in your own project, then you can quickly customize the type ( see <a href="https://github.com/rmw-lib/mdbx-example/blob/master/02/src/main.rs" target="_blank" rel="noopener noreferrer">github.com/rmw-lib/mdbx-example/02</a> for demo code).</p><div class="language-rust ext-rs"><pre class="language-rust"><code>use db::User;
