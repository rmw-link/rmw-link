import{_ as t,o as e,c as p,a as n,b as o,F as c,d as a,e as l,r}from"./app.278ef889.js";const i={},k=n("h1",{id:"electron-perfect-drag-and-drop-egy-elegansabb-megvalositas-mint-az-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-egy-elegansabb-megvalositas-mint-az-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : egy eleg\xE1nsabb megval\xF3s\xEDt\xE1s, mint az electron-drag")],-1),u=n("p",null,"A term\xE9kmenedzser k\xE9rte, hogy az elektron ablak alatti eszk\xF6zt\xE1r blokkolja a jobb eg\xE9rgombot.",-1),d=n("p",null,[a("A nat\xEDv drag and drop az elektronban az ablak alatt ( "),n("code",null,"app-region:drag"),a(") megeszi a kattint\xE1si esem\xE9nyt, \xE9s nincs m\xF3d a jobb klikk blokkol\xE1s\xE1ra. A drag and dropot k\xE9zzel kell v\xE9grehajtania.")],-1),f=n("p",null,"Ha a mousemove esem\xE9nyt haszn\xE1lja a k\xF6vetelm\xE9ny megval\xF3s\xEDt\xE1s\xE1hoz, akkor az eg\xE9r gyors mozg\xE1sa eset\xE9n az eg\xE9r kiker\xFCl az ablak hat\xF3k\xF6r\xE9b\u0151l, \xE9s az ablak m\xE1r nem k\xF6veti az egeret.",-1),g=a("Ezt a k\xF6vetelm\xE9nyt a mutat\xF3 esem\xE9ny alapj\xE1n val\xF3s\xEDtottam meg, a "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),b=a(" haszn\xE1lat\xE1val a BrowserWindow-n k\xEDv\xFCli eg\xE9rpoz\xEDci\xF3 r\xF6gz\xEDt\xE9s\xE9re, \xE9s t\xF6k\xE9letesen m\u0171k\xF6dik."),v=l(`<p>Ez a megold\xE1s jobb, mint az electron-drag megold\xE1s: platformf\xFCgg\u0151 bin\xE1ris f\xFCgg\u0151s\xE9gekkel rendelkezik, \xE9s a friss\xEDt\xE9s \xE9s a csomagol\xE1s is f\xE1jdalmas lehet.</p><p>\xDAgy tal\xE1ltam, hogy ezt a megold\xE1st m\xE9g senki sem eml\xEDtette a vil\xE1gh\xE1l\xF3n, ez\xE9rt blogot \xEDrok r\xF3la \xE9s megosztom.</p><p>A megval\xF3s\xEDt\xE1sok k\xF6z\xF6tti k\xF3dbeli k\xFCl\xF6nbs\xE9geket az al\xE1bbiakban csak referenciak\xE9nt soroljuk fel. Az alapk\xF3d a <code>web/src/lib/drag.coffee</code> \xE9s a <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function w(y,_){const s=r("ExternalLinkIcon");return e(),p(c,null,[k,u,d,f,n("p",null,[g,n("a",m,[h,o(s)]),b]),v],64)}var z=t(i,[["render",w],["__file","2022-03-14.electron-drag.html.vue"]]);export{z as default};
