import{_ as e,r as o,o as p,c,a as s,b as t,F as l,d as n,e as u}from"./app.525299a3.js";const r={},k=s("h1",{id:"merkle-tree-based-on-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-tree-based-on-blake3","aria-hidden":"true"},"#"),n(" Merkle tree based on blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),h=n(" is based on the merkle tree implementation, but the exposed interface does not export the merkle tree."),m={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},f=n("bao"),b=n(" implements streaming blake3 verification, but does not "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("support"),y=n(" resizing the underlying "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},w=n('chunks (support larger "chunk groups" for reduced space overhead'),v=n(" )."),q=s("p",null,"The current implementation of bao consumes 6% extra storage space to record validation hashes, which is a significant overhead for a content index server.",-1),H=n("My implementation of "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle"),F=n(", when "),L=s("code",null,"BLOCK_CHUNK",-1),M=n(" is set to 10, outputs a 32-byte hash for every (1 << 10)*1024 = 1MB, adding only 0.3\u2031 of additional overhead."),N=u(`<p><code>./examples/main.rs</code> As follows :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function z(D,K){const a=o("ExternalLinkIcon");return p(),c(l,null,[k,s("p",null,[s("a",i,[d,t(a)]),h]),s("p",null,[s("a",m,[f,t(a)]),b,s("a",_,[g,t(a)]),y,s("a",x,[w,t(a)]),v]),q,s("p",null,[H,s("a",B,[E,t(a)]),F,L,M]),N],64)}var A=e(r,[["render",z],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{A as default};
