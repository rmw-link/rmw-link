import{_ as t,o as p,c as o,a as s,b as e,F as c,d as n,e as l,r as u}from"./app.30fd0c1f.js";const k={},i=s("h1",{id:"merkle-puu-pohineb-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-puu-pohineb-blake3","aria-hidden":"true"},"#"),n(" Merkle puu p\xF5hineb blake3")],-1),r={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" p\xF5hineb merkle-puul, kuid avalikustatud liides ei ekspordi merkle-puud."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" rakendab blake3 voogedastuse valideerimist, kuid ei saa muuta aluseks olevate "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("t\xFCkkide"),v=n(" suurust (vt "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},x=n('suuremate "t\xFCkkide r\xFChmade" toetamine, et v\xE4hendada ruumi koormust'),w=n(" )."),q=s("p",null,"See t\xE4hendab, et bao kulutab Merkle-puu salvestamiseks 6% lisam\xE4luruumi, mis on jaotatud sisuindeksi puhul m\xE4rkimisv\xE4\xE4rne lisakulu.",-1),H=n("Seega rakendasin "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},M=n("blake3_merkle'i"),E=n(", et tuletada 32 baiti hashi 1 MB sisu kohta, mille t\xE4iendav salvestuskoormus on 0,3\u2031."),j=l(`<p>Merkle-puu genereerib hashed, mis on koosk\xF5las blake3-ga.</p><p>Kui sisu on v\xE4iksem v\xF5i v\xF5rdne 1MB, on Merkle-puul ainult \xFCks s\xF5lm ja selle s\xF5lme hash on v\xF5rdne blake3 hashiga.</p><p><code>./examples/main.rs</code> J\xE4rgnevalt :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,6);function F(D,K){const a=u("ExternalLinkIcon");return p(),o(c,null,[i,s("p",null,[s("a",r,[d,e(a)]),m]),s("p",null,[s("a",h,[b,e(a)]),f,s("a",_,[g,e(a)]),v,s("a",y,[x,e(a)]),w]),q,s("p",null,[H,s("a",B,[M,e(a)]),E]),j],64)}var N=t(k,[["render",F],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{N as default};
