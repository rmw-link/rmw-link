import{_ as e,r as p,o,c,a as s,b as t,F as l,d as n,e as u}from"./app.32c338c0.js";const k={},i=s("h1",{id:"merkle-puu-pohineb-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-puu-pohineb-blake3","aria-hidden":"true"},"#"),n(" Merkle puu p\xF5hineb blake3")],-1),r={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3-l"),m=n(" on aluseks merkle-puu, kuid avalikustatud liides ei saa merkle-puud eksportida."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" rakendab blake3 voogedastuse valideerimist, kuid ei saa muuta aluseks olevate "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("t\xFCkkide"),v=n(" suurust "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},x=n('(toetab suuremaid "t\xFCkkide gruppe", et v\xE4hendada ruumi koormust'),w=n(" )."),q=s("p",null,"See t\xE4hendab, et bao kulutab Merkle-puu salvestamiseks 6% lisam\xE4luruumi, mis on jaotatud sisuindeksi puhul m\xE4rkimisv\xE4\xE4rne lisakulu.",-1),H=n("Seega rakendasin "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle'i"),j=n(", et eksportida 32 baiti hashi 1 MB sisu kohta, mille t\xE4iendav salvestuskoormus on 0,3\u2031."),F=u(`<p><code>./examples/main.rs</code> J\xE4rgnevalt :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function M(D,L){const a=p("ExternalLinkIcon");return o(),c(l,null,[i,s("p",null,[s("a",r,[d,t(a)]),m]),s("p",null,[s("a",h,[b,t(a)]),f,s("a",_,[g,t(a)]),v,s("a",y,[x,t(a)]),w]),q,s("p",null,[H,s("a",B,[E,t(a)]),j]),F],64)}var V=e(k,[["render",M],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
