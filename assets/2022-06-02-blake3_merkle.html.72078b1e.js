import{_ as t,r as o,o as p,c,a,b as e,F as l,d as n,e as u}from"./app.a65c7036.js";const r={},k=a("h1",{id:"arbol-de-merkle-basado-en-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#arbol-de-merkle-basado-en-blake3","aria-hidden":"true"},"#"),n(" \xC1rbol de Merkle basado en blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" se apoya en un \xE1rbol de merkle, pero la interfaz expuesta no exporta el \xE1rbol de merkle."),b={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},h=n("bao"),f=n(" implementa la validaci\xF3n de streaming de blake3, pero no puede redimensionar los "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunks"),y=n(" subyacentes (ver "),x={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},q=n('soporte de "grupos de chunks" m\xE1s grandes para reducir la sobrecarga de espacio'),w=n(" )."),v=a("p",null,"Esto significa que bao consume un 6% adicional de espacio de almacenamiento para registrar el \xE1rbol de merkle, lo que supone una sobrecarga importante para un \xEDndice de contenido distribuido.",-1),H=n("As\xED que implement\xE9 "),E={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},B=n("blake3_merkle"),D=n(" para exportar 32 bytes de hash por 1MB de contenido, con una sobrecarga de almacenamiento adicional de 0,3\u2031."),F=u(`<p>El \xE1rbol merkle puede generar hashes consistentes con blake3.</p><p>Cuando el contenido es menor o igual a 1MB, el \xE1rbol de merkle s\xF3lo tiene un nodo y el hash de este nodo es igual al hash de blake3.</p><p><code>./examples/main.rs</code> De la siguiente manera :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,6);function M(z,L){const s=o("ExternalLinkIcon");return p(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",b,[h,e(s)]),f,a("a",_,[g,e(s)]),y,a("a",x,[q,e(s)]),w]),v,a("p",null,[H,a("a",E,[B,e(s)]),D]),F],64)}var V=t(r,[["render",M],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
