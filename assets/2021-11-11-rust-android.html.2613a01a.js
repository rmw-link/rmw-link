import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";import{e as n}from"./app.040d9bb0.js";const o={},r=n(`<h1 id="compilazione-di-kiss-ftpd-programma-in-linguaggio-rust-per-set-top-box-android" tabindex="-1"><a class="header-anchor" href="#compilazione-di-kiss-ftpd-programma-in-linguaggio-rust-per-set-top-box-android" aria-hidden="true">#</a> Compilazione di kiss-ftpd (programma in linguaggio rust) per set-top box android</h1><p>La busybox viene fornita con un codice ftp disordinato, quindi ho intenzione di compilare un <a href="https://github.com/moparisthebest/kiss-ftpd" target="_blank" rel="noopener noreferrer">kiss-ftpd</a> da usare sul set-top box.</p><p>In primo luogo <code>rustup target add aarch64-linux-android</code></p><p>Poi installate l&#39;NDK per Android, io l&#39;ho fatto con Android Studio, screenshot qui sotto.</p><p><img src="//irmw.gumlet.io/qcUqsK.png" alt=""></p><p>Naturalmente, potete anche <a href="https://developer.android.com/ndk/downloads" target="_blank" rel="noopener noreferrer">scaricare direttamente l&#39;NDK e scompattarlo</a>.</p><p>Nel 2021, la <a href="https://github.com/mozilla/rust-android-gradle/issues/75#issuecomment-970179046" target="_blank" rel="noopener noreferrer">versione pi\xF9 alta dell&#39;NDK supportata da rust \xE8 la 22.1.7171670</a>, quindi usate prima quella.</p><p>Infine, lo script di compilazione \xE8 il seguente.</p><div class="language-bash ext-sh"><pre class="language-bash"><code>#!/usr/bin/env bash
