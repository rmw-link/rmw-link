import{_ as t,r as p,o,c,a,b as e,F as l,d as n,e as u}from"./app.cc5206ad.js";const r={},k=a("h1",{id:"merkleboom-gebaseerd-op-blake3",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#merkleboom-gebaseerd-op-blake3","aria-hidden":"true"},"#"),n(" Merkleboom gebaseerd op blake3")],-1),i={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" wordt ondersteund door een merkle tree, maar de blootgelegde interface exporteert de merkle tree niet."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" implementeert blake3 streaming validatie, maar kan de grootte van de onderliggende "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("chunks"),x=n(" niet wijzigen (zie "),v={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('ondersteuning van grotere "chunk groups" voor minder ruimte-overhead'),w=n(" )."),q=a("p",null,"Dit betekent dat bao 6% extra opslagruimte nodig heeft om de merkle tree op te slaan, wat een aanzienlijke overhead is voor een gedistribueerde inhoudsindex.",-1),H=n("Dus heb ik "),z={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},B=n("blake3_merkle"),E=n(" ge\xEFmplementeerd om 32 bytes hash te exporteren per 1MB inhoud, met een extra opslagoverhead van 0.3\u2031."),D=u(`<p><code>./examples/main.rs</code> Als volgt :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function F(L,M){const s=p("ExternalLinkIcon");return o(),c(l,null,[k,a("p",null,[a("a",i,[d,e(s)]),m]),a("p",null,[a("a",h,[b,e(s)]),f,a("a",_,[g,e(s)]),x,a("a",v,[y,e(s)]),w]),q,a("p",null,[H,a("a",z,[B,e(s)]),E]),D],64)}var V=t(r,[["render",F],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{V as default};
