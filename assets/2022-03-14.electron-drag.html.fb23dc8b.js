import{_ as e,r as t,o as p,c as o,a as n,b as c,F as r,d as a,e as l}from"./app.9f6dcb37.js";const i={},u=n("h1",{id:"electron-perfect-drag-and-drop-een-elegantere-implementatie-dan-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-een-elegantere-implementatie-dan-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : een elegantere implementatie dan electron-drag")],-1),k=n("p",null,"De productmanager heeft gevraagd of de werkbalk onder het elektronenvenster de rechtermuisknop kan blokkeren.",-1),d=n("p",null,[a("De native drag and drop in electron onder window ( "),n("code",null,"app-region:drag"),a(") vreet de click event en er is geen manier om rechtsklik te blokkeren. Je moet het slepen en neerzetten handmatig uitvoeren.")],-1),f=n("p",null,"Als je het mousemove event gebruikt om de eis te implementeren, gaat de muis, wanneer hij snel beweegt, buiten het bereik van het venster en volgt het venster de muis niet langer.",-1),g=a("Ik heb deze eis ge\xEFmplementeerd op basis van de pointer event, met "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),w=a(" om de muispositie buiten het BrowserWindow vast te leggen, en het werkt perfect."),v=l(`<p>Deze oplossing is beter dan de electron-drag oplossing: het heeft platform-afhankelijke binaire afhankelijkheden en kan een pijn zijn om te upgraden en te packagen.</p><p>Ik ontdekte dat nog niemand deze oplossing op het web heeft genoemd, dus ik blog erover en deel het.</p><p>De codeverschillen tussen de implementaties worden hieronder alleen ter referentie opgesomd. De kerncode is <code>web/src/lib/drag.coffee</code> en <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function b(y,_){const s=t("ExternalLinkIcon");return p(),o(r,null,[u,k,d,f,n("p",null,[g,n("a",m,[h,c(s)]),w]),v],64)}var B=e(i,[["render",b],["__file","2022-03-14.electron-drag.html.vue"]]);export{B as default};
