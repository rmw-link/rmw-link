import{_ as e,r as t,o as p,c as o,a as n,b as c,F as r,d as a,e as l}from"./app.b761d2b7.js";const u={},i=n("h1",{id:"electron-perfect-drag-and-drop-una-implementacion-mas-elegante-que-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-una-implementacion-mas-elegante-que-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : una implementaci\xF3n m\xE1s elegante que electron-drag")],-1),k=n("p",null,"El responsable del producto pidi\xF3 que la barra de herramientas bajo la ventana de electrones bloqueara el bot\xF3n derecho del rat\xF3n.",-1),d=n("p",null,[a("La funci\xF3n nativa de arrastrar y soltar en electr\xF3n bajo ventana ( "),n("code",null,"app-region:drag"),a(") se come el evento de clic y no hay manera de hacer el bloqueo del clic derecho. Hay que implementar el drag and drop manualmente.")],-1),f=n("p",null,"Si se utiliza el evento mousemove para implementar el requisito, cuando el rat\xF3n se mueve r\xE1pidamente, sale del alcance de la ventana y \xE9sta ya no sigue al rat\xF3n.",-1),g=a("He implementado este requisito basado en el evento del puntero, utilizando "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),w=a(" para capturar la posici\xF3n del rat\xF3n fuera del BrowserWindow, y funciona perfectamente."),v=l(`<p>Esta soluci\xF3n es mejor que la de electron-drag: tiene dependencias binarias dependientes de la plataforma y puede ser un dolor para actualizar y empaquetar.</p><p>He descubierto que nadie ha mencionado a\xFAn esta soluci\xF3n en la web, as\xED que la estoy publicando en el blog y comparti\xE9ndola.</p><p>Las diferencias de c\xF3digo entre las implementaciones se enumeran a continuaci\xF3n s\xF3lo como referencia. El c\xF3digo del n\xFAcleo es <code>web/src/lib/drag.coffee</code> y <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function b(y,_){const s=t("ExternalLinkIcon");return p(),o(r,null,[i,k,d,f,n("p",null,[g,n("a",m,[h,c(s)]),w]),v],64)}var q=e(u,[["render",b],["__file","2022-03-14.electron-drag.html.vue"]]);export{q as default};
