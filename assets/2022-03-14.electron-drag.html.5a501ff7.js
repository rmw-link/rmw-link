import{_ as e,r as t,o as p,c as o,a as n,b as c,F as r,d as a,e as l}from"./app.dd3830d7.js";const i={},u=n("h1",{id:"electron-perfect-drag-and-drop-un-implementazione-piu-elegante-di-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-un-implementazione-piu-elegante-di-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop: un'implementazione pi\xF9 elegante di electron-drag")],-1),k=n("p",null,"Il responsabile del prodotto ha richiesto che la barra degli strumenti sotto la finestra dell'elettrone blocchi il tasto destro del mouse.",-1),d=n("p",null,[a("Il drag and drop nativo in electron sotto finestra ( "),n("code",null,"app-region:drag"),a(") mangia l'evento click e non c'\xE8 modo di fare il blocco del click destro. Dovete implementare il drag and drop manualmente.")],-1),f=n("p",null,"Se usate l'evento mousemove per implementare il requisito, quando il mouse si muove rapidamente, esce dal raggio della finestra e la finestra non segue pi\xF9 il mouse.",-1),g=a("Ho implementato questo requisito basandomi sull'evento puntatore, usando "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),w=a(" per catturare la posizione del mouse fuori dalla BrowserWindow, e funziona perfettamente."),v=l(`<p>Questa soluzione \xE8 migliore di quella di electron-drag: ha dipendenze binarie dipendenti dalla piattaforma e pu\xF2 essere un dolore per aggiornare e pacchettizzare.</p><p>Ho scoperto che nessuno ha ancora menzionato questa soluzione sul web, quindi ne parlo nel blog e la condivido.</p><p>Le differenze di codice tra le implementazioni sono elencate di seguito solo per riferimento. Il codice di base \xE8 <code>web/src/lib/drag.coffee</code> e <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function b(y,_){const s=t("ExternalLinkIcon");return p(),o(r,null,[u,k,d,f,n("p",null,[g,n("a",m,[h,c(s)]),w]),v],64)}var q=e(i,[["render",b],["__file","2022-03-14.electron-drag.html.vue"]]);export{q as default};
