import{_ as t,o as e,c as p,a as n,b as o,F as c,d as a,e as l,r}from"./app.278ef889.js";const u={},i=n("h1",{id:"electron-perfect-drag-and-drop-elegantnejsi-implementace-nez-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-elegantnejsi-implementace-nez-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : elegantn\u011Bj\u0161\xED implementace ne\u017E electron-drag")],-1),k=n("p",null,"Spr\xE1vce produktu po\u017Eadoval, aby panel n\xE1stroj\u016F pod oknem electron blokoval prav\xE9 tla\u010D\xEDtko my\u0161i.",-1),d=n("p",null,[a("P\u0159i nativn\xEDm p\u0159etahov\xE1n\xED v Electronu pod oknem ( "),n("code",null,"app-region:drag"),a(") se ud\xE1lost kliknut\xED vyhod\xED a nen\xED mo\u017En\xE9 blokovat kliknut\xED prav\xFDm tla\u010D\xEDtkem my\u0161i. P\u0159etahov\xE1n\xED je nutn\xE9 prov\xE9st ru\u010Dn\u011B.")],-1),f=n("p",null,"Pokud k implementaci po\u017Eadavku pou\u017Eijete ud\xE1lost mousemove, p\u0159i rychl\xE9m pohybu my\u0161i se tato dostane mimo dosah okna a okno ji\u017E nebude sledovat my\u0161.",-1),m=a("Tento po\u017Eadavek jsem implementoval na z\xE1klad\u011B ud\xE1losti ukazatele pomoc\xED "),g={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),v=a(" pro zachycen\xED polohy my\u0161i mimo okno BrowserWindow a funguje to perfektn\u011B."),w=l(`<p>Toto \u0159e\u0161en\xED je lep\u0161\xED ne\u017E \u0159e\u0161en\xED electron-drag: m\xE1 bin\xE1rn\xED z\xE1vislosti z\xE1visl\xE9 na platform\u011B a jeho aktualizace a bal\xED\u010Dkov\xE1n\xED m\u016F\u017Ee b\xFDt nep\u0159\xEDjemn\xE9.</p><p>Zjistil jsem, \u017Ee se o tomto \u0159e\u0161en\xED na webu zat\xEDm nikdo nezm\xEDnil, a tak o n\u011Bm p\xED\u0161u blog a sd\xEDl\xEDm ho.</p><p>Rozd\xEDly v k\xF3du mezi implementacemi jsou uvedeny n\xED\u017Ee pouze pro informaci. Z\xE1kladn\xED k\xF3d je <code>web/src/lib/drag.coffee</code> a <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function y(b,_){const s=r("ExternalLinkIcon");return e(),p(c,null,[i,k,d,f,n("p",null,[m,n("a",g,[h,o(s)]),v]),w],64)}var j=t(u,[["render",y],["__file","2022-03-14.electron-drag.html.vue"]]);export{j as default};
