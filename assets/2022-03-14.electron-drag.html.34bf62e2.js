import{_ as t,r as p,o as e,c as o,a as n,b as c,F as r,d as s,e as l}from"./app.b98954e4.js";const u={},i=n("h1",{id:"electron-\u5B8C\u7F8E\u62D6\u62FD-\u6BD4-electron-drag-\u66F4\u4F18\u96C5\u7684\u5B9E\u73B0",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-\u5B8C\u7F8E\u62D6\u62FD-\u6BD4-electron-drag-\u66F4\u4F18\u96C5\u7684\u5B9E\u73B0","aria-hidden":"true"},"#"),s(" electron \u5B8C\u7F8E\u62D6\u62FD : \u6BD4 electron-drag \u66F4\u4F18\u96C5\u7684\u5B9E\u73B0")],-1),k=n("p",null,"\u4EA7\u54C1\u7ECF\u7406\u8981\u6C42 electron window \u4E0B\u7684\u5DE5\u5177\u6761\u5C4F\u853D\u9F20\u6807\u53F3\u952E\u3002",-1),d=n("p",null,[s("window \u4E0B electron \u7684\u539F\u751F\u62D6\u62FD("),n("code",null,"app-region:drag"),s(")\u4F1A\u5403\u6389\u70B9\u51FB\u4E8B\u4EF6\uFF0C\u6CA1\u6CD5\u505A\u53F3\u952E\u5C4F\u853D\u3002\u5FC5\u987B\u81EA\u5DF1\u624B\u5DE5\u5B9E\u73B0\u62D6\u62FD\u624D\u884C\u3002")],-1),f=n("p",null,"\u5982\u679C\u4F7F\u7528 mousemove \u4E8B\u4EF6\u5B9E\u73B0\u9700\u6C42 \uFF0C\u5728\u9F20\u6807\u5FEB\u901F\u79FB\u52A8\u7684\u65F6\u5019\uFF0C\u4F1A\u8D85\u51FA\u7A97\u4F53\u8303\u56F4\uFF0C\u5BFC\u81F4\u7A97\u4F53\u4E0D\u518D\u8DDF\u968F\u9F20\u6807\u79FB\u52A8\u3002",-1),g=s("\u6211\u57FA\u4E8E pointer event \u5B9E\u73B0\u4E86\u8FD9\u4E2A\u9700\u6C42\uFF0C\u7528 "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},w=s("setPointerCapture"),h=s(" \u53EF\u4EE5\u6355\u83B7 BrowserWindow \u4E4B\u5916\u7684\u9F20\u6807\u4F4D\u7F6E\uFF0C\u6548\u679C\u5F88\u5B8C\u7F8E\u3002"),v=l(`<p>\u6B64\u65B9\u6848\u6BD4 electron-drag \u7684\u65B9\u6848\u66F4\u4F18 : \u5B83\u6709\u5E73\u53F0\u76F8\u5173\u7684\u4E8C\u8FDB\u5236\u4F9D\u8D56\uFF0C\u5347\u7EA7\u6253\u5305\u90FD\u4F1A\u53D8\u5F97\u9EBB\u70E6\u3002</p><p>\u6211\u53D1\u73B0\u7F51\u4E0A\u8FD8\u6CA1\u6709\u4EBA\u63D0\u8FC7\u8FD9\u79CD\u65B9\u6848\uFF0C\u6240\u4EE5\u5199\u535A\u5BA2\u8BB0\u5F55\u5E76\u5206\u4EAB\u4E00\u4E0B\u3002</p><p>\u5B9E\u73B0\u65B9\u6848\u7684\u4EE3\u7801\u5DEE\u5F02\u5982\u4E0B\uFF0C\u4EC5\u591F\u53C2\u8003\u3002\u6838\u5FC3\u4EE3\u7801\u662F <code>web/src/lib/drag.coffee</code> \u548C <code>main/ipc/drag.coffee</code>\u3002</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function y(b,_){const a=p("ExternalLinkIcon");return e(),o(r,null,[i,k,d,f,n("p",null,[g,n("a",m,[w,c(a)]),h]),v],64)}var B=t(u,[["render",y],["__file","2022-03-14.electron-drag.html.vue"]]);export{B as default};
