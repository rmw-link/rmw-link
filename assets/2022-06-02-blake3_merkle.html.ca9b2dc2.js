import{_ as e,r as p,o,c,a as s,b as t,F as l,d as n,e as u}from"./app.32c338c0.js";const k={},r=s("h1",{id:"merkle-tree-based-on-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-tree-based-on-blake3","aria-hidden":"true"},"#"),n(" Merkle tree based on blake3")],-1),i=n("The underlying merkle tree of "),d={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},h=n("blake3"),m=n(" is a merkle tree, but the exposed interface cannot export the merkle tree."),f={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),_=n(" implements blake3 streaming verification, but cannot resize the underlying "),g={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},y=n('chunks (support larger "chunk groups" for reduced space overhead'),x=n(" )."),w=s("p",null,"This means that bao consumes 6% extra storage space to record the merkle tree, which is a significant overhead for a distributed content index.",-1),q=n("So, I implemented "),v={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},H=n("blake3_merkle"),B=n(" to export 32 bytes of hash per 1MB of content with an additional storage overhead of only 0.3\u2031."),E=u(`<p><code>./examples/main.rs</code> As follows :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,4);function F(z,D){const a=p("ExternalLinkIcon");return o(),c(l,null,[r,s("p",null,[i,s("a",d,[h,t(a)]),m]),s("p",null,[s("a",f,[b,t(a)]),_,s("a",g,[y,t(a)]),x]),w,s("p",null,[q,s("a",v,[H,t(a)]),B]),E],64)}var M=e(k,[["render",F],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{M as default};
