import{_ as t,r as p,o,c,a as s,b as e,F as l,d as n,e as u}from"./app.a65c7036.js";const k={},i=s("h1",{id:"merkle-puu-pohineb-blake3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#merkle-puu-pohineb-blake3","aria-hidden":"true"},"#"),n(" Merkle puu p\xF5hineb blake3")],-1),r={href:"https://github.com/BLAKE3-team/BLAKE3",target:"_blank",rel:"noopener noreferrer"},d=n("blake3"),m=n(" aluseks on merkle-puu, kuid avalikustatud liides ei ekspordi merkle-puud."),h={href:"https://github.com/oconnor663/bao",target:"_blank",rel:"noopener noreferrer"},b=n("bao"),f=n(" rakendab blake3 voogedastuse valideerimist, kuid ei saa muuta aluseks olevate "),_={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},g=n("t\xFCkkide"),v=n(" suurust (vt "),y={href:"https://github.com/oconnor663/bao/issues/34",target:"_blank",rel:"noopener noreferrer"},x=n('suuremate "t\xFCkkide r\xFChmade" toetamine ruumi koormuse v\xE4hendamiseks'),w=n(" )."),q=s("p",null,"See t\xE4hendab, et bao kulutab merkle-puu salvestamiseks t\xE4iendavalt 6% salvestusruumi, mis on jaotatud sisuindeksi puhul m\xE4rkimisv\xE4\xE4rne lisakulu.",-1),H=n("Seega rakendasin "),B={href:"https://github.com/rmw-lib/blake3_merkle",target:"_blank",rel:"noopener noreferrer"},E=n("blake3_merkle'i"),M=n(", et eksportida 32 baiti hashi 1 MB sisu kohta, mille t\xE4iendav salvestuskoormus on 0,3\u2031."),j=u(`<p>Merkle-puu suudab genereerida blake3-ga koosk\xF5las olevaid hashe&#39;e.</p><p>Kui sisu on v\xE4iksem v\xF5i v\xF5rdne 1MB, on Merkle-puul ainult \xFCks s\xF5lm ja selle s\xF5lme hash on v\xF5rdne blake3 hashiga.</p><p><code>./examples/main.rs</code> J\xE4rgnevalt :</p><div class="language-rust ext-rs"><pre class="language-rust"><code><span class="token keyword">use</span> <span class="token namespace">blake3_merkle<span class="token punctuation">::</span></span><span class="token class-name">Merkle</span><span class="token punctuation">;</span>
...
</code></pre></div>`,6);function F(D,K){const a=p("ExternalLinkIcon");return o(),c(l,null,[i,s("p",null,[s("a",r,[d,e(a)]),m]),s("p",null,[s("a",h,[b,e(a)]),f,s("a",_,[g,e(a)]),v,s("a",y,[x,e(a)]),w]),q,s("p",null,[H,s("a",B,[E,e(a)]),M]),j],64)}var N=t(k,[["render",F],["__file","2022-06-02-blake3_merkle.html.vue"]]);export{N as default};
