import{_ as t,r as e,o as p,c as o,a as n,b as c,F as r,d as a,e as l}from"./app.a65c7036.js";const i={},u=n("h1",{id:"electron-perfect-drag-and-drop-a-more-elegant-implementation-than-electron-drag",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron-perfect-drag-and-drop-a-more-elegant-implementation-than-electron-drag","aria-hidden":"true"},"#"),a(" electron perfect drag and drop : a more elegant implementation than electron-drag")],-1),k=n("p",null,"The product manager asked the toolbar under electron window to block the right mouse button.",-1),d=n("p",null,[a("The native drag and drop of electron under window ( "),n("code",null,"app-region:drag"),a(") eats the click event, so there is no way to do right click blocking. I have to implement drag and drop manually.")],-1),f=n("p",null,"If I use the mousemove event to achieve the requirement, when the mouse moves quickly, it will be out of the range of the form and the form will no longer follow the mouse movement.",-1),g=a("I implemented this requirement based on the pointer event, using "),m={href:"https://developer.mozilla.org/zh-CN/docs/Web/API/Element/setPointerCapture",target:"_blank",rel:"noopener noreferrer"},h=a("setPointerCapture"),w=a(" to capture the mouse position outside of the BrowserWindow, and it works perfectly."),v=l(`<p>This solution is better than the electron-drag solution: it has platform-dependent binary dependencies, which makes it a pain to upgrade and package.</p><p>I found that no one has mentioned this solution on the web yet, so I&#39;m blogging about it and sharing it.</p><p>The code differences between the implementations are as follows, just for reference. The core code is <code>web/src/lib/drag.coffee</code> and <code>main/ipc/drag.coffee</code>.</p><h2 id="web-src-lib-drag-coffee" tabindex="-1"><a class="header-anchor" href="#web-src-lib-drag-coffee" aria-hidden="true">#</a> web/src/lib/drag.coffee</h2><div class="language-coffee ext-coffee"><pre class="language-coffee"><code>import $<span class="token keyword">on</span> from <span class="token string">&#39;~/lib/on.coffee&#39;</span>
...
export <span class="token function">default</span> <span class="token punctuation">(</span><span class="token parameter">elem<span class="token punctuation">,</span> dict</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span>
  ...
  onUnmounted unbind
  unbind
</code></pre></div>`,18);function b(y,_){const s=e("ExternalLinkIcon");return p(),o(r,null,[u,k,d,f,n("p",null,[g,n("a",m,[h,c(s)]),w]),v],64)}var B=t(i,[["render",b],["__file","2022-03-14.electron-drag.html.vue"]]);export{B as default};
